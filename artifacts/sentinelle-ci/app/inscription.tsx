...
export default function InscriptionScreen() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      Alert.alert("Inscription réussie", "Bienvenue sur SentinelleCI !", [
        { text: "OK", onPress: () => router.replace("/(tabs)") },
      ]);
    } catch (err: any) {
      let msg = "Erreur lors de l'inscription.";
      if (err.code === "auth/email-already-in-use") msg = "Ce numéro est déjà inscrit.";
      if (err.code === "auth/invalid-email") msg = "Numéro de téléphone invalide.";
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.subtitle}>
            Rejoignez votre commune pour signaler les problèmes
          </Text>
          ...
          <View style={styles.field}>
            ...
            <View style={styles.inputWrap}>
              <Feather name="user" size={18} color="#6B7785" style={styles.inputIcon} />
              <TextInput
                style={styles.input}
